...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['post_now'])) {
    ...
    $pdo->exec("UPDATE produk SET displayed_on_productpage = 0");
    ...
    foreach ($_SESSION['display'] as $userId => $totalDisplayed) {
        ...
        if (!empty($productIds)) {
            ...
            $updateQuery = "UPDATE produk SET displayed_on_productpage = 1 WHERE id IN ($productIdsList)";
    ...
    header("Location: ../Dashboard/Products/product.php");
    exit();
}


// Berguna untuk total product displayed 
...
// Batas maksimal produk yang bisa ditampilkan di produpage
$maxProductsAtHome = 28;
...
<head>
    ...
    <title>FashionXP | Admin-Product</title>
